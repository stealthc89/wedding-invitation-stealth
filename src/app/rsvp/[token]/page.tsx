      ...
      <PhotoSlideshow overlay="dark">
        ...
        {submitted ? (
          <div className="glass-card rounded-2xl p-8 text-center animate-fade-in">
            ...
            {attending && (
              <p className="text-sm text-white font-medium italic text-center mt-6 mb-4 pt-4 border-t border-white/20" style={{ textShadow: '0 2px 12px rgba(0,0,0,1), 0 1px 4px rgba(0,0,0,0.9)' }}>
